...
namespace MoFaim.Services
{
    public class StarBehavior : Behavior<View>
    {
        ...
        public static string GroupNameResto;
       // public static int count = 1;
        ...
        {
            StarBehavior behavior = (StarBehavior)bindable;
            //string groupName = GroupNameResto;
            //starGroups.Add(groupName,behavior);
            ...
            if ((bool)newValue)
            {
                ...
                Console.WriteLine("===================group=======" + GroupNameProperty.PropertyName);
                ...
                foreach (var item in behaviors)
                {
                    ...
                    if (item != behavior && itemReached)
                    {
                        Console.WriteLine("===================Stared FALSE=======");
